...
import { CodeIcon, HomeIcon, NotebookIcon, PencilLine, GlobeIcon, MailIcon, SmilePlus } from 'lucide-react'

export type IconProps = React.HTMLAttributes<SVGElement>

export const Icons = {
    globe: (props: IconProps) => <GlobeIcon {...props} />,
    smile: (props: IconProps) => <SmilePlus {...props} />,
...
export const DATA = {
    navbar: [
        ...
        { href: '#', icon: PencilLine, label: 'Contact' },
    ],
    contact: {
        social: {
            GitHub: {
